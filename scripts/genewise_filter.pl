...
my $usage = <<USAGE;
Usage:
    perl $0 genewise.gff genome_seq.fasta Min_score Min_cds_length Min_exon_number hmmscan_Evalue hmmscan_coverage_ratio CPUs > genewise.filter.gff
...
my $Pfam_db = "/home/train/public_database/pfam/Pfam-A.hmm";
